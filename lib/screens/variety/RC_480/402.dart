...
class ResistanceItem {
  ...
  final int resistanceLevel; // 0: Susceptible, 1: Intermediate, 2: Resistant
...
class Rc402Page extends StatelessWidget {
  Rc402Page({super.key}); // Added const constructor

  // Specific data for NSIC Rc 402
  final List<ResistanceItem> diseaseItems = [
    ResistanceItem(
        title: 'Rice Blast',
        imagePath: 'assets/images/diseases/blast2.jpg',
        resistanceLevel: 1), // Intermediate
    ResistanceItem(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text(
          'NSIC Rc 402 Profile', // Corrected from 480 to 402
  ...
  // ... (The rest of your helper functions _buildHeaderSection,
  // _buildResistanceCard, and _buildShields remain the same)
